...
(1, 3, 'patron@library.com', 'Alex Morgan (Demo Patron)', 'LIB-MEM-1001', 'ACTIVE', NOW() - INTERVAL 60 DAY),
...
(1, 1, 'patron@library.com', 'Alex Morgan (Demo Patron)', 1, 'The Cloud Architect Handbook', NOW() - INTERVAL 5 DAY, NOW() + INTERVAL 9 DAY, NULL, 'BORROWED', 'Regular 14-day checkout'),
(2, 1, 'patron@library.com', 'Alex Morgan (Demo Patron)', 2, 'Chronicles of the Starfarer', NOW() - INTERVAL 12 DAY, NOW() + INTERVAL 2 DAY, NULL, 'BORROWED', 'Due soon'),
